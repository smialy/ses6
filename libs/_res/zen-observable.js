(function (fn, name) { if (typeof exports !== 'undefined') { fn(exports, module); } else if (typeof self !== 'undefined') { const e = name === '*' ? self : (name ? self[name] = {} : {}); fn(e, { exports: e }); } }((exports, module) => { // === Symbol Support ===
  ...
  function addMethods(target, methods) {
    Object.keys(methods).forEach((k) => {
      const desc = Object.getOwnPropertyDescriptor(methods, k);
  ...
  // Assert:  observer._observer is undefined
    ...
    try { cleanup(); } catch (e) { hostReportError(e); }
  }
  ...
  // Assert: subscriber is callable
    ...
    try {
      const start$0 = getMethod(observer, 'start');
    ...
    // Call the subscriber function
      let cleanup$0 = subscriber.call(undefined, observer);
  ...
  addMethods(SubscriptionObserver.prototype = {}, {
    ...
    next(value) {
      ...
      // If the observer has a "next" method, send the next value
        const m$0 = getMethod(observer, 'next');
    ...
    error(value) {
      ...
      try {
        const m$1 = getMethod(observer, 'error');
    ...
    complete() {
      ...
      try {
        const m$2 = getMethod(observer, 'complete');
  ...
  addMethods(Observable.prototype, {
    ...
    map(fn) {
      ...
      return new C((observer => __this.subscribe({
        next(value) {
  ...
  addMethods(Observable, {
    ...
    from(x) {
      ...
      if (method) {
        const observable$0 = method.call(x);
      ...
      if (Array.isArray(x)) {
        return new C(((observer) => {
          for (let i$0 = 0; i$0 < x.length; ++i$0) {
            observer.next(x[i$0]);
            if (observer.closed) { return; }
          }
